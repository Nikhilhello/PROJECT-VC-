...
#tkinter is initialized
root=Tk()
#making window non-resizable
root.resizable(0,0)
#adding  image as icon
icon=PhotoImage(file=r'main files\icon.png')
#setting image as icon and True parameter sets icon to toplevel windows
...
def win():  #function called when 'b' Button is pressed (first page of project)
     
   b.destroy()#clearing the buttom
...
#_________________________________________loading all the image files to set images on widgets in the program___________________________________________________________________________________________   
   ...
   def tab1():   #first  page of project contains info,image,text buttons
      def tab2():  #2nd page of project contains all image processing functions
          ...
          b2.destroy()
          b18.destroy()
          def tab_hand():  #contains image to handwriting function
              l6.config(text='')
          ...
          def i_to_sp():  #image to speech function
               l6.config(text='')
          ...
          def i_T():  #image to text function
              l6.config(text='')
      ...
      def tab3():  #__________text processing page contains text to voice and text to handwriting
          def tab_vo():  # page that contains file and textbox options to convert to speech
              ...
              def dest4():
                  ...
                  l5.destroy()
                  tab3()
              def t_to_sp(): #calls a function to select a text file and convert ot to voice
                  l5.config(text='')
                  try:
          ...
          def tab_hwr(): # this contains file and text box options to convert the given input as handwriting image file
              ...
              def tab_fh(): #selecting a text file and converts to handwriting image file
                  stri=''  
                  l3.config(text='')
...
b.pack(pady=30)
bb=can.create_window(500,300,window=b)#creating a window as a button to display it on canvas
